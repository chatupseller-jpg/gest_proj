...
function renderDashboard(main) {
  ...
  const activeDaily = [...state.dailyTasks.filter(d => d.is_active)].sort((a, b) => {
...
function dailyModalHTML(d) {
  return `
    ...
    <div class="field">
      ...
      <p style="color:var(--paper-dim);font-size:0.78rem;margin:4px 0 0;">Define a ordem do hábito na trilha de hoje. Deixe em branco para hábitos sem horário fixo (aparecem no final).</p>
    </div>
    <div class="toggle-row">
